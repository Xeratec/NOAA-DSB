...
% %0-55 are earth view and each of the 20 words is a band
...
%     imgData = uint8(fliplr((cdata(:,1:maxElement,idx2)-HIRSmin)/(HIRSmax)));
%     image(imgData); 
...
%           end
%           
%           if(DCSdata(frame,byte) == 214) %(what is 0x06 (6) and oxD0 (208) doing in dataset 18)
%           %if(DCSdata(frame,byte) == 69)
%               sFlag=idx-1;
%           end
%           
%           idx = idx + 1;
...
% for frame=1:numel(minorFrameID)
%     %SBUVLines(
%     %if(minorFrameID(frame) - intpart(minorFrameID(frame)/10) == 1)
%     if(mod(minorFrameID(frame)-0,10) == 0)
%             SBUVLines(idx(1),1,1) = SBUVdata(frame,1);
%             SBUVLines(idx(1),1,2) = SBUVdata(frame,2);
%             idx(1)=idx(1)+1;
%     elseif(mod(minorFrameID(frame)-1,10) == 0)
%             SBUVLines(idx(2),2,1) = SBUVdata(frame,1);
%             SBUVLines(idx(2),2,2) = SBUVdata(frame,2);
%             idx(2)=idx(2)+1;
%     elseif(mod(minorFrameID(frame)-2,10) == 0)
%             SBUVLines(idx(3),3,1) = SBUVdata(frame,1);
%             SBUVLines(idx(3),3,2) = SBUVdata(frame,2);
%             idx(3)=idx(3)+1;
%     elseif(mod(minorFrameID(frame)-3,10) == 0)
%             SBUVLines(idx(4),4,1) = SBUVdata(frame,1);
%             SBUVLines(idx(4),4,2) = SBUVdata(frame,2);
%             idx(4)=idx(4)+1;
%     elseif(mod(minorFrameID(frame)-4,10) == 0)
%             SBUVLines(idx(5),5,1) = SBUVdata(frame,1);
%             SBUVLines(idx(5),5,2) = SBUVdata(frame,2);
%             idx(5)=idx(5)+1;
%     elseif(mod(minorFrameID(frame)-5,10) == 0)
%             SBUVLines(idx(6),6,1) = SBUVdata(frame,1);
%             SBUVLines(idx(6),6,2) = SBUVdata(frame,2);
%             idx(6)=idx(6)+1;
%     elseif(mod(minorFrameID(frame)-6,10) == 0)
%             SBUVLines(idx(7),7,1) = SBUVdata(frame,1);
%             SBUVLines(idx(7),7,2) = SBUVdata(frame,2);
%             idx(7)=idx(7)+1;
%     elseif(mod(minorFrameID(frame)-7,10) == 0)
%             SBUVLines(idx(8),8,1) = SBUVdata(frame,1);
%             SBUVLines(idx(8),8,2) = SBUVdata(frame,2);
%             idx(8)=idx(8)+1;
%     elseif(mod(minorFrameID(frame)-8,10) == 0)
%             SBUVLines(idx(9),9,1) = SBUVdata(frame,1);
%             SBUVLines(idx(9),9,2) = SBUVdata(frame,2);
%             idx(9)=idx(9)+1;
%     elseif(mod(minorFrameID(frame)-9,10) == 0)
%             SBUVLines(idx(10),10,1) = SBUVdata(frame,1);
%             SBUVLines(idx(10),10,2) = SBUVdata(frame,2);
%             idx(10)=idx(10)+1;
%     end
%     %elseif 
% end
% %% SBUV/2 - Plot some stuff
% plot(SBUVLines(:,8,1),'-x')
% 
% %% SBUV/2 - Who knows?
% 
% plot(SBUVLines(:,1,2),'-x')
% hold on
% plot(SBUVLines(:,2,2),'-o')
% plot(SBUVLines(:,3,2),'-+')
% hold off