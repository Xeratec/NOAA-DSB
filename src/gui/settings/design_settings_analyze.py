...
class Ui_DialogAnalyzeSettings(object):
    def setupUi(self, DialogAnalyzeSettings):
        ...
        self.lFilterLevel = QtWidgets.QLabel(DialogAnalyzeSettings)
        self.lFilterLevel.setObjectName("lFilterLevel")
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.lFilterLevel)
        self.cbFilterLevel = QtWidgets.QComboBox(DialogAnalyzeSettings)
        self.cbFilterLevel.setObjectName("cbFilterLevel")
        self.cbFilterLevel.addItem("")
        self.cbFilterLevel.addItem("")
        self.cbFilterLevel.addItem("")
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.cbFilterLevel)
    ...
    def retranslateUi(self, DialogAnalyzeSettings):
        ...
        self.lFilterLevel.setText(_translate("DialogAnalyzeSettings", "Filter Method"))
        self.cbFilterLevel.setItemText(0, _translate("DialogAnalyzeSettings", "Unfiltered"))
        self.cbFilterLevel.setItemText(1, _translate("DialogAnalyzeSettings", "Parity"))
        self.cbFilterLevel.setItemText(2, _translate("DialogAnalyzeSettings", "Full"))
