...
class Ui_DialogDemodSettings(object):
    def setupUi(self, DialogDemodSettings):
        ...
        self.cbBaudRate.setCurrentIndex(0)
    ...
    def retranslateUi(self, DialogDemodSettings):
        ...
        self.cbBaudRate.setItemText(0, _translate("DialogDemodSettings", "9600"))
        self.cbBaudRate.setItemText(1, _translate("DialogDemodSettings", "14400"))
        self.cbBaudRate.setItemText(2, _translate("DialogDemodSettings", "19200"))
        self.cbBaudRate.setItemText(3, _translate("DialogDemodSettings", "38400"))
        self.cbBaudRate.setItemText(4, _translate("DialogDemodSettings", "48000"))
        self.cbBaudRate.setItemText(5, _translate("DialogDemodSettings", "56250"))
        self.cbBaudRate.setItemText(6, _translate("DialogDemodSettings", "57600"))
        self.cbBaudRate.setItemText(7, _translate("DialogDemodSettings", "115200"))
