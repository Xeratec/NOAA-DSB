...
# Title: Mpsk Stage5
# Generated: Tue Apr 30 10:29:59 2019
##################################################
...
class mpsk_stage5(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.samp_rate = samp_rate = 56250
        self.rrc_taps = rrc_taps = firdes.root_raised_cosine(nfilts, nfilts, 1.0/float(sps), 0.35, 11*sps*nfilts)
        self.phase_bw = phase_bw = 6.28/100.0
        self.min_freq_deviation = min_freq_deviation = -500
        self.max_freq_deviation = max_freq_deviation = 500
        self.excess_bw = excess_bw = 0.35
        self.eq_gain = eq_gain = 0.01
        self.arity = arity = 4

        self.NOAA_DSB_Constellation = NOAA_DSB_Constellation = digital.constellation_calcdist(([0.3907-0.9205j, 0.3907+0.9205j]), ([0, 1]), 0, 1).base()
        ...
        self.qtgui_number_sink_0.set_title("Byte Output")
        ...
        self.digital_constellation_receiver_cb_0 = digital.constellation_receiver_cb(NOAA_DSB_Constellation, phase_bw, min_freq_deviation, max_freq_deviation)
        ...
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\Sevy\\Desktop\\School\\ETH\\SDR\\Packed Byte Out.txt', False)
        self.blocks_file_sink_1.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, 'C:\\Users\\Sevy\\Desktop\\School\\ETH\\SDR\\Byte Out.txt', False)
        self.blocks_file_sink_0.set_unbuffered(True)
        self.blocks_char_to_float_0 = blocks.char_to_float(1, 1)
        self.analog_agc3_xx_0 = analog.agc3_cc(500e-3, 1, 1.0, 1.0, 1)
        ...
        self.connect((self.analog_agc3_xx_0, 0), (self.qtgui_const_sink_x_2, 0))
        ...
        self.connect((self.digital_constellation_receiver_cb_0, 0), (self.qtgui_number_sink_0, 0))
    ...
    def get_min_freq_deviation(self):
        return self.min_freq_deviation

    def set_min_freq_deviation(self, min_freq_deviation):
        self.min_freq_deviation = min_freq_deviation

    def get_max_freq_deviation(self):
        return self.max_freq_deviation

    def set_max_freq_deviation(self, max_freq_deviation):
        self.max_freq_deviation = max_freq_deviation
